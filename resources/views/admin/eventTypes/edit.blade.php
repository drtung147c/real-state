    ...
    <div class="card-body">
        <form action="{{ route("admin.event-types.update", [$eventType->id]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="name">{{ trans('cruds.eventType.fields.user_name') }}*</label>
                <input type="hidden" id="user_id" name="user_id" class="form-control" value="{{ $eventType->users->id }}">
                <input type="text" id="user_name" class="form-control" value="{{ $eventType->users->name }}" disabled>
            </div>
            ...
            <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                <label for="description">{{ trans('cruds.eventType.fields.description') }}</label>
                <textarea id="description" name="description" class="form-control ">{{ old('description', isset($eventType) ? $eventType->description : '') }}</textarea>
                ...
                @endif
                <p class="helper-block">
                    {{ trans('cruds.eventType.fields.description_helper') }}
                </p>
            </div>
